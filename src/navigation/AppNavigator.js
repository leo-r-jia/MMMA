...
function AppNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="HomeScreen" component={HomeView} options={{ gestureEnabled: false }} />
      ...
      <Stack.Screen name="EmailConfirmedScreen" component={EmailConfirmedView} options={{ gestureEnabled: false }} />
